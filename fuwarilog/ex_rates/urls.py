...
from .views import ExRateView, RatePredictView, ExchangeStatView, RateDirectionView, TravelRateForecasView
...
urlpatterns = [
    ...
    path('v1/predict-tripcur/',TravelRateForecasView.as_view(), name='travelrate-forecast-predict'),
]
